    ...
    <div ref={ref} className="w-full">
      <div className="flex w-full flex-col items-center justify-center max-w-7xl mx-auto">
        <div className="grid h-full grid-cols-5 gap-x-10 px-10 md:px-20 items-center w-full">
            ...
            >
              {featureItems.map((item, index) => (
                ...
                >
                  ...
                  <AccordionContent className="text-sm font-medium overflow-hidden">
          ...
          <div
            className={`col-span-5 h-[350px] md:h-[500px] min-h-[200px] w-auto lg:col-span-3 ${
              ltr && "md:order-1"
            }`}
          >
            {renderMedia()}
            ...
            {featureItems.map((item, index) => (
              ...
              >
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <p className="mx-0 max-w-sm text-balance text-sm font-medium leading-relaxed line-clamp-3">
                    {item.description}
                  </p>
                  {item.description &&
                    item.description.split(" ").length > 30 && (
