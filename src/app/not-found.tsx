...
const NotFoundPage = () => {
  return (
    <div className="min-h-screen flex items-center justify-center flex-col space-y-2 relative">
      <h1 className="absolute top-[20px] left-1/2 transform -translate-x-1/2 text-[8rem] lg:text-[25rem] bg-transparent font-bold px-4 hidden lg:block">
        404
      </h1>
