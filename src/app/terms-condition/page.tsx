      ...
      <div className="px-4 py-8 md:px-8 lg:px-12 xl:px-16">
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            This website is operated by Rauch International India Private
            Limited. Throughout the site, the terms “we”, “us” and “our” refer
            to Rauch International India Private Limited. Rauch International
            India Private Limited offers this website, including all
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            You shall not use our products for any illegal or unauthorized
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            ...
            immediate termination of your Services and open to legal action.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            ...
            any time without assigning any explanation.
          </p>
          <p className="text-gray-700 leading-relaxed mb-4">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            In no case shall Rauch International India Private Limited, our
            ...
            the amount of the amount of contract under consideration.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            You agree to indemnify, defend and hold harmless Rauch International
            India Private Limited and our parent, subsidiaries, affiliates,
